...
import { ClienteService, ClienteDto } from '../../ventas/service/cliente.service';
...
export class ClienteListComponent implements OnInit, AfterViewInit {
  displayedColumns: string[] = [
    'nombre', 'telefono', 'documento', 'edit'
  ];
  ...
  filterClientes(searchTerm: string) {
    ...
    this.filteredDataSource = this.dataSource.filter(cliente =>
