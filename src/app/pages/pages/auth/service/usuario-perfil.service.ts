...
export class UsuarioPerfilService {
  ...
  /**
   * Actualiza la personalización del perfil del usuario.
   * Obtiene primero el perfil para conseguir el id y luego hace PUT.
   * @param personalizacion Objeto de personalización (ej: { productos: { verTabla: "barcode,nombre,..." } })
   */
